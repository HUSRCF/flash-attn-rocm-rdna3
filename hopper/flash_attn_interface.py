...
USE_CK_ROCM = os.getenv("FLASH_ATTENTION_CK_ENABLE", "FALSE") == "TRUE"
...
if USE_TRITON_ROCM:
    ...
    # CK backend uses flash_attn_2_cuda module which exposes compatible interface
    import flash_attn_2_cuda as flash_attn_3_gpu  # type: ignore
else:
    # isort: off
