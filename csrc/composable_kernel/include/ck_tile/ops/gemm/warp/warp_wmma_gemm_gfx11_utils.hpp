...
// This function transforms one distribution to another for GEMM-GEMM scenarios.
...
CK_TILE_DEVICE static constexpr void PermuteWarpGemmCToA(OutTensor& out, const InTensor& in)
{
    ...
    // once instead of swapping w and v every time.
    ...
    static_for<0, n_out, 1>{}([&](auto i) {
        ...
        const auto w =
            __builtin_amdgcn_permlanex16(0, v, 0x76543210, 0xfedcba98, false, true);
