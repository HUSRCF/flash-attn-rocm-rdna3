...
struct WmmaTraitsBase<gfx11_t, ADType, BDType, CDType>
{
    ...
    // 原代码：(FIXATION HERE FOR TRIAL ONLY!!!)
    ...
    //New Code:
    //fixation at 20260313HUSRCF
    //using kCTPs2RHssMajor = sequence<1, 2>; // <--- 变了！用 kCPs2RHssMajor 的值
    //using kCTPs2RHssMinor = sequence<0, 1>; // 保持不动
    //using kCTYs2RHsMajor  = sequence<2, 2>; // <--- 变了！用 kCYs2RHsMajor 的值
    //using kCTYs2RHsMinor  = sequence<0, 2>; // 保持不动
};
